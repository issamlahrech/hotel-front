	...
	return (
		<>
			<div className="container mt-5 d-flex flex-column justify-content-center align-items-center">
				<h2 className="text-center mb-4">Ma reservation</h2>
				...
				{isLoading ? (
					...
					<div className="col-md-6 mt-4 mb-5">
						<h3>Informations</h3>
						<p className="text-success">Code de confirmations: {bookingInfo.bookingConfirmationCode}</p>
						...
						<p>Total: {bookingInfo.totalNumOfGuests}</p>
